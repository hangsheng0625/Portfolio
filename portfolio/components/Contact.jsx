    ...
    <section id="contact" className="py-16 px-6 lg:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h4 className="text-3xl font-bold font-ovo text-darkTheme mb-4">
            Get In Touch
          </h4>
          <h2 className="text-lg font-ovo text-darkTheme mb-6">Contact Me</h2>
          ...
          <div className="pt-8">
            <h4 className="font-semibold text-darkTheme mb-4">Follow Me</h4>
